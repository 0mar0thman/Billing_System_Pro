...
@section('title') الفواتير المدفوع جزئيا@stop
@section('css')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex align-items-center">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الفواتير المدفوع جزئيا</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                ...
                                @foreach ($invoices as $invoice)
                                    @if($invoice->Value_Status == 3)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $invoice->Total }}</td>
                                            <td>
                                                <span class="badge badge-warning">مدفوع جزئيا</span>
                                            </td>
                                            <td>

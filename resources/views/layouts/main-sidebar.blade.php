...
<aside class="app-sidebar sidebar-scroll">
    {{-- <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'index')) }}">
            <img src="{{ URL::asset('assets/img/brand/omar_software_d.png') }}" class="main-logo"
                alt="logo" " style="transform: scale(4); display: block; opacity: 0.7;">
        </a>
        <a class="desktop-logo logo-dark active" href="{{ url('/' . ($page = 'index')) }}">
            <img
                src="{{ URL::asset('assets/img/brand/omar-white.png') }}" class="main-logo dark-theme"
                alt="logo">
            </a>
        <a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . ($page = 'index')) }}">
            <img
                src="{{ URL::asset('assets/img/brand/omar_white_demo.png') }}" class="logo-icon" alt="logo">
            </a>
        <a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . ($page = 'index')) }}">
            <img
                src="{{ URL::asset('assets/img/brand/omar-white.png') }}" class="logo-icon dark-theme"
                alt="logo">
         </a>
    </div> --}}
    <div class="">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/circle-user-solid.svg') }}"><span
        ...
        <ul class="side-menu">
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}"><svg
                    ...
                    </svg><span class="side-menu__label mr-2">الرئيسية</span>
                </a>
            </li>
            ...
            @can('الفواتير')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label mr-2">الفواتير</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('اضافة فاتورة')
                            <li><a class="slide-item" href="{{ route('invoices.create') }}">فاتورة جديدة</a></li>
                        @endcan
                        @can('قائمة الفواتير')
                        ...
                        @endcan
                        @can('اعدادات الفواتير')
                            <li><a class="slide-item" href="{{ route('invoices.sittings') }}">اعدادات الفواتير</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            ...
            @can('الاعدادات')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                        ...
                        <span class="side-menu__label mr-2">بنوك و عملاء</span><i class="angle fe fe-chevron-down"></i>
                    </a>
                    <ul class="slide-menu">
                        @can('الاقسام')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'sections')) }}">اضافة بنك</a></li>
                        @endcan
                        @can('المنتجات')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'products')) }}">اضافة عميل</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                        ...
                        <span class="side-menu__label mr-2">التقارير</span><i class="angle fe fe-chevron-down"></i>
                    </a>
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
            ...
            @can('المستخدمين')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                        ...
                        <span class="side-menu__label mr-2">المستخدمين</span><i class="angle fe fe-chevron-down"></i>
                    </a>
                    <ul class="slide-menu">
                        @can('اضافة مستخدم')

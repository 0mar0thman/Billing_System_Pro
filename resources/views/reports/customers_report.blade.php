{{-- page views/reports/customers_report.blade --}}
...
<script> 
    $(document).ready(function() {
        $('select[name="section_id"]').on('change', function() {
            ...
            if (sectionId) {
                productSelect.empty();
                productSelect.append('<option selected>جارٍ التحميل...</option>');
                ...
                $.ajax({
                    ...
                    error: function() {
                        productSelect.empty();
                        productSelect.append(
                            '<option selected disabled>حدث خطأ أثناء التحميل</option>');
                    }
                });
            } else {
